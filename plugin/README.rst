...
flavor :kbd:`]` :kbd:`[a-z]`), I just found the keybinding :kbd:`g]`! Thanks
to inspiration from the varying commands in ``:he tagsrch`` I'd recommend
trying out these mappings.::
