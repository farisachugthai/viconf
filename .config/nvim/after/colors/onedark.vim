...
" Mar 08, 2019: Accidentally fucked up the quotes matching each other; however, Vim isn't highlighting those words anymore so whatever.

" Gave my first try to a regex in vim with:
" `:'<,'>s/\s"/'/g
...
" customize the look of onedark.vim.
